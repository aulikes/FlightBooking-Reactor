...
# Script de despliegue de Redis en Kubernetes (entorno local)
...
echo ""
echo "Aplicando manifiestos YAML para Redis..."
...
echo ""
echo "Redis desplegado correctamente en el namespace '$NAMESPACE'."
echo "Verifica con: kubectl get pods -n $NAMESPACE -l app=redis"
