...
@Component
@Slf4j
public class ReservationCreatedEventPublisherKafka
        extends AbstractKafkaEventPublisher<ReservationCreatedEvent>
        implements ReservationCreatedEventPublisher {

    private final AppProperties properties;

    public ReservationCreatedEventPublisherKafka(AppProperties properties,
            KafkaTemplate<String, IntegrationEventWrapper<ReservationCreatedEvent>> kafkaTemplate) {
        super(kafkaTemplate);
